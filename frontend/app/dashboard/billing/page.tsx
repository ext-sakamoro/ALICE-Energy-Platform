...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['5 simulations/day', 'Li-ion battery only', 'Basic demand forecast', 'Community support'] },
  { name: 'Pro', price: '$199/mo', features: ['Unlimited simulations', 'All battery types (Li-ion, LiFePO4, solid-state, flow)', 'Battery degradation prediction', '24hr grid optimization', 'Demand forecasting', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'Real-time grid integration', 'Custom battery models', 'Renewable optimization', 'SLA 99.99%', 'Dedicated support'] },
];
